...
<html>
  ...
  <body  class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
        ...
        <c:out value="${mensaje}"/>       
        <h1>Administracion de Tratamiento!</h1>
        ...
        <td>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                          <c:if test="${!empty ListaTratamiento}">
                            <table border="1">
                                <tr>
                                    <th>Nombre</th>
                                    <th>Apellidos</th>
                ...
                <c:forEach items="${ListaTratamiento}" var= "dato">   
                <tr>
                    ...
                    <td>
                        <a href="eliminarDiagnostico?id=${dato.idTratamiento}">Eliminar</a>&emsp14;                                        
                    </td>
                </tr>
                </c:forEach>
                            </table>
